...
if __name__ == "__main__" :
    ...
    gui.configure(background = "cadetblue")
    ...
    enterTask = Label(gui, text = "Enter Your Task", bg = "teal")
    ...
    Submit = Button(gui, text = "Done", fg = "Black", bg = "skyblue", command = insertTask)
    ...
    taskNumber = Label(gui, text = "Delete Task Number", bg = "bisque")
    ...
    delete = Button(gui, text = "Delete", fg = "Black", bg = "peru", command = delete)
